...
load("@com_github_doevelopper_atlassians//tools/off_the_shelf_software/boost:boost.bzl", "boost_library", "boost_so_library", "default_copts", "default_defines", "hdr_list")
...
boost_library(
    name = "asio",
    srcs = [
        "@com_github_doevelopper_atlassians//tools/off_the_shelf_software/boost:src/build_asio.cpp",
    ],
    defines = [
...
cc_library(
    name = "asio_ssl",
    srcs = [
        "@com_github_doevelopper_atlassians//tools/off_the_shelf_software/boost:src/build_asio_ssl.cpp",
    ],
    visibility = ["//visibility:public"],
    deps = [
        ":asio",
...
boost_library(
    name = "beast",
    srcs = [
        "@com_github_doevelopper_atlassians//tools/off_the_shelf_software/boost:src/build_beast.cpp",
    ],
    defines = [
