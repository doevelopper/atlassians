#ifndef COM_GITHUB_DOEVELOPPER_ATLASSIANS_COMPILERDETECTION_HPP
#define COM_GITHUB_DOEVELOPPER_ATLASSIANS_COMPILERDETECTION_HPP
...
// #ifndef SDLC_MUSTTAIL
//     #if defined(__clang__)
//         #define SDLC_MUSTTAIL [[clang::musttail]]
//     #else
//         #define SDLC_MUSTTAIL
//     #endif
// #endif
...
/*!
 * @brief Define a public class constructor with no argument
 *
...
/*!
 * @brief Define a public class constructor with one argument
 *
 *      Also make sure the Pimpl is initalized
 */
...
/*!
 * @brief Define the setter in the public class.
 *
...
#endif
// Concurrent programmming parameters
#define BACKOFF_LINEAR      0
#define BACKOFF_EXPONENTIAL 1
#define BACKOFF_EQUALSTEP   2
...
/*!
 * @brief There are situations where is approach is not possible, as for instance in case the
