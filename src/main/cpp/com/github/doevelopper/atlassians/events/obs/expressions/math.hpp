...
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_EVENTS_OBS_EXPRESSIONS_MATH_HPP
#define COM_GITHUB_DOEVELOPPER_PREMISSES_EVENTS_OBS_EXPRESSIONS_MATH_HPP

#include <cmath>
#include <cstdlib>
#include <com/github/doevelopper/atlassians/events/obs/expressions/filters.hpp>
