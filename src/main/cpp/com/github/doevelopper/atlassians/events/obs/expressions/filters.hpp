...
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_EVENTS_OBS_EXPRESSIONS_EXPRESSION_HPP
#define COM_GITHUB_DOEVELOPPER_PREMISSES_EVENTS_OBS_EXPRESSIONS_EXPRESSION_HPP
...
namespace com::github::doevelopper::atlassians::events::obs::expr_detail
{
