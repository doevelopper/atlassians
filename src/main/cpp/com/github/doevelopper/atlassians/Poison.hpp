...
#ifndef COM_GITHUB_DOEVELOPPER_ATLASSIANS_POISON_HPP
#define COM_GITHUB_DOEVELOPPER_ATLASSIANS_POISON_HPP
...
#endif /* COM_GITHUB_DOEVELOPPER_ATLASSIANS_POISON_HPP */
