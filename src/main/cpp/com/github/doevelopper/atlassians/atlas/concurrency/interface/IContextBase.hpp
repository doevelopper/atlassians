...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICONTEXT_BASE_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICONTEXT_BASE_H
...
namespace Bloomberg::quantum
{
     ...
     struct IContextBase
     {
          ...
          *      future will re-throw this exception. Any threads or coroutines already blocked on this future will
...
#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICONTEXT_BASE_H
