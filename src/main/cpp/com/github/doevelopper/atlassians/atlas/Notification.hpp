...
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_UTILS_NOTIFICATION_HPP
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_UTILS_NOTIFICATION_HPP
...
namespace com::github::doevelopper::atlassians::atlas::utils
{
    ...
    /*!
    @code{.cpp}
        com::github::doevelopper::atlassians::atlas::utils::Notification<std::string> notification;
