...
#include <com/github/doevelopper/atlassians/atlas/time/TimeoutGuard.hpp>

using namespace com::github::doevelopper::atlassians::atlas::time;

log4cxx::LoggerPtr TimeoutGuard::logger =
    log4cxx::Logger::getLogger(std::string("com.github.doevelopper.premisses.atlas.time.TimeoutGuard"));
...
{
    // LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    // this->m_guard_thread = std::thread(&TimeoutGuard::guard, this);
}
