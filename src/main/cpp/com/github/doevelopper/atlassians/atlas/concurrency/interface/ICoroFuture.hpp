...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICORO_FUTURE_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICORO_FUTURE_H
...
namespace Bloomberg::quantum
{
        ...
        template <typename T>
        inline log4cxx::LoggerPtr ICoroFuture<T>::logger =
            log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.ICoroFuture" ) );
...
#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICORO_FUTURE_H
