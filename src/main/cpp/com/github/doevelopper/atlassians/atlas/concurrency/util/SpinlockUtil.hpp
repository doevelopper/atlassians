...
namespace Bloomberg::quantum
{
        ...
        struct SpinLockUtil
        {
            static bool lockWrite(std::atomic_uint32_t & flag, LockTraits::Attempt);
            static bool lockRead(std::atomic_uint32_t & flag, LockTraits::Attempt);
            static bool upgradeToWrite(std::atomic_uint32_t & flag, LockTraits::Attempt);
            static bool upgradeToWrite(std::atomic_uint32_t & flag, bool & pendingUpgrade, LockTraits::Attempt);
        ...
        private:
            ...
            static bool upgradeToWriteImpl(std::atomic_uint32_t & flag, bool & pendingUpgrade, LockTraits::Attempt);
    ...
    inline log4cxx::LoggerPtr SpinLockUtil::logger =
        log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.util.SpinLockUtil" ) );

}

#include <com/github/doevelopper/atlassians/atlas/concurrency/util/SpinlockUtil.ipp>
