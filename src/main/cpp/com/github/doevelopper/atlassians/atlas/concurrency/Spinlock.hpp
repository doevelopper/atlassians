...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_SPINLOCK_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_SPINLOCK_H
...
namespace Bloomberg::quantum
{
        ...
        */
        ...
        public:
            ...
            */
            ...
            public:
                ...
                */
                Guard(SpinLock & lock, LockTraits::TryToLock tryLock);
                ...
                */
                Guard(SpinLock & lock, LockTraits::AdoptLock adoptLock);
                ...
                */
                Guard(SpinLock & lock, LockTraits::DeferLock deferLock);
        ...
        private:
            ...
            alignas(128) std::atomic_uint32_t m_flag {0};
            LOG4CXX_DECLARE_STATIC_LOGGER
        };
    inline log4cxx::LoggerPtr SpinLock::logger =
    log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.SpinLock" ) );
    inline log4cxx::LoggerPtr SpinLock::Guard::logger =
    log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.SpinLock.Guard" ) );
    inline log4cxx::LoggerPtr SpinLock::ReverseGuard::logger =
    log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.SpinLock.ReverseGuard" ) );
}

#include <com/github/doevelopper/atlassians/atlas/concurrency/Spinlock.ipp>

#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_SPINLOCK_H
