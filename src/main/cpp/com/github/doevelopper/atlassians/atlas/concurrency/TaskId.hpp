...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_TASK_ID_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_TASK_ID_H
...
namespace Bloomberg::quantum
{
        ...
        inline log4cxx::LoggerPtr TaskId::logger =
            log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.TaskId" ) );
        std::ostream & operator<<(std::ostream &, const TaskId &);
}

#include <com/github/doevelopper/atlassians/atlas/concurrency/TaskId.ipp>
...
#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_TASK_ID_H
