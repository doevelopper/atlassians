...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_LOCAL_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_LOCAL_H
...
namespace Bloomberg::quantum::local
{
            /*!
             ...
             *      pointers will be freed. It is up to the user of the API to free the actual variable storage.
             */
            template <typename T>
...
#include <com/github/doevelopper/atlassians/atlas/concurrency/Local.ipp>

#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_LOCAL_H
