...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ITHREAD_PROMISE_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ITHREAD_PROMISE_H
...
namespace Bloomberg::quantum
{
        ...
        */
        ...
        struct IThreadPromise : public Traits::DerivedFrom<PROMISE<T>, IThreadPromise<PROMISE, T>, IPromiseBase>
        {
            ...
            IThreadPromise([[maybe_unused]] Impl * derived)
            {
//                UNUSED(derived);
            }
        ...
        template <template <class> class PROMISE, class T>
        inline log4cxx::LoggerPtr IThreadPromise<PROMISE, T>::logger =
            log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.IThreadPromise" ) );
        ...
        template <class T>
        struct Traits::InnerType<std::shared_ptr<IThreadPromise<Promise, T>>>
        {
            using Type = T;
        };
...
#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ITHREAD_PROMISE_H
