...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_IQUEUE_STATISTICS_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_IQUEUE_STATISTICS_H
...
namespace Bloomberg::quantum
{
        ...
        struct IQueueStatistics
        {
            ...
            /// @return Counter value.
            virtual std::size_t sharedQueueErrorCount() const = 0;
            ...
            /// @return Counter value.
            virtual std::size_t completedCount() const = 0;
            ...
            /// @return Counter value.
            virtual std::size_t sharedQueueCompletedCount() const = 0;
            ...
            /// @return Counter value.
            virtual std::size_t postedCount() const = 0;
            ...
            /// @return Counter value.
            virtual std::size_t  highPriorityCount() const = 0;
...
#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_IQUEUE_STATISTICS_H
