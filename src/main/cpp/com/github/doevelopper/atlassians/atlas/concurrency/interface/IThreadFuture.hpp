...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ITHREAD_FUTURE_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ITHREAD_FUTURE_H
...
namespace Bloomberg::quantum
{
        ...
        template <typename T>
        inline log4cxx::LoggerPtr IThreadFuture<T>::logger =
            log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.IThreadFuture" ) );
...
#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ITHREAD_FUTURE_H
