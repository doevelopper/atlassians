...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_CONFIGURATION_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_CONFIGURATION_H
...
namespace Bloomberg::quantum
{
        ...
        public:
             ...
             *     When the number of backoffs is reached, the poll interval remains unchanged
             *     thereafter.
             * @return A reference to itself
             */
             ...
             * @param[in] coroQueueIdRangeForAny The range [minQueueId, maxQueueId] of queueIds that
             *      IQueue::QueueId::Any  will cover.
        ...
        private:
            ...
            int m_numCoroutineThreads {-1};
            int m_numIoThreads {5};
            bool m_pinCoroutineThreadsToCores {false};
            bool m_loadBalanceSharedIoQueues {false};
            std::chrono::milliseconds m_loadBalancePollIntervalMs {100};
            BackoffPolicy _loadBalancePollIntervalBackoffPolicy {BackoffPolicy::Linear};
            size_t m_loadBalancePollIntervalNumBackoffs {0};
            std::pair<int, int> m_coroQueueIdRangeForAny {-1, -1};
            bool m_coroutineSharingForAny {false};
            TaskStateConfiguration m_taskStateConfiguration;
            LOG4CXX_DECLARE_STATIC_LOGGER
        };
    inline log4cxx::LoggerPtr Configuration::logger =
    log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.Configuration" ) );
}

#include <com/github/doevelopper/atlassians/atlas/concurrency/Configuration.ipp>

#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_CONFIGURATION_H
