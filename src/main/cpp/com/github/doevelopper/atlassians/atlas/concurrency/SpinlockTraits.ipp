...
{
        inline size_t & SpinLockTraits::minSpins()
        {
        ...
        inline size_t & SpinLockTraits::maxSpins()
        {
            LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
        ...
        inline size_t & SpinLockTraits::numYieldsBeforeSleep()
        {
            LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
        ...
        inline std::chrono::microseconds & SpinLockTraits::sleepDuration()
        {
            LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
        ...
        inline SpinLockTraits::BackoffPolicy & SpinLockTraits::backoffPolicy()
        {
            LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
