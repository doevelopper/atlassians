...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_SEQUENCER_CONFIGURATION_EXPERIMENTAL_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_SEQUENCER_CONFIGURATION_EXPERIMENTAL_H
...
namespace Bloomberg::quantum::experimental
{
     ...
     * @tparam SequenceKey Type of the key based that sequenced tasks are associated with in
     *      quantum::experimental::Sequencer
     *
     * @tparam Hash Hash-function used for storing instances of SequenceKey in hash maps in
     *      quantum::experimental::Sequencer
     *
     * @tparam KeyEqual The equal-function used for storing instances of SequenceKey in hash maps in
     *      quantum::experimental::Sequencer
     *
     * @tparam Allocator The allocator used for storing instances of SequenceKey in hash maps in
     *      quantum::experimental::Sequencer
     */
    template <
...
#include <com/github/doevelopper/atlassians/atlas/concurrency/util/SequencerConfigurationExperimental.ipp>

#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_SEQUENCER_CONFIGURATION_EXPERIMENTAL_H
