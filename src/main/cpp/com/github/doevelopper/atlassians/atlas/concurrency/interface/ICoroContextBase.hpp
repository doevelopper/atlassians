...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICORO_CONTEXT_BASE_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICORO_CONTEXT_BASE_H
...
namespace Bloomberg::quantum
{
        ...
        struct ICoroContextBase : public virtual IContextBase, public ICoroSync
        {
            ...
            /// @return 'ready' if value was posted before duration expired or 'timeout' otherwise.
            /// @note Blocks until the value is ready, until 'timeMs' duration expires or until an exception is thrown.
            virtual std::future_status waitForAt(
                int num, ICoroSync::Ptr sync, std::chrono::milliseconds timeMs) const = 0;
...
#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICORO_CONTEXT_BASE_H
