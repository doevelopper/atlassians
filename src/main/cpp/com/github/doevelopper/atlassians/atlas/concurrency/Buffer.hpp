...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_FUTURE_ITERATOR_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_FUTURE_ITERATOR_H
...
namespace Bloomberg::quantum
{
        ...
        enum class BufferStatus
        {
            ...
            Closed ///< Buffer is closed. Push operations are not allowed. Pull operations are allowed until buffer is
                   ///< emtpy.
        };
        ...
        public:
             ...
             * @param[out] value Reference to the variable which will contain the next valid value if return value is
             *      'DataReceived'.
             * @return Result of the operation. See BufferStatus above for more details.
             */
            ...
            /*!
             * @brief Close the buffer. Once this method is called, push operations are no longer permitted. Pull
             *      operations are permitted until the buffer empties.
             */
            void close();
        ...
        private:
            ...
            std::deque<T, ALLOCATOR> m_buffer;
            bool m_isClosed;
            LOG4CXX_DECLARE_STATIC_LOGGER
        };
        template <class T, class ALLOCATOR>
        inline log4cxx::LoggerPtr Buffer<T, ALLOCATOR>::logger =
            log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.DispatcherCore" ) );
}

#include <com/github/doevelopper/atlassians/atlas/concurrency/Buffer.ipp>

#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_FUTURE_ITERATOR_H
