...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ITHREAD_CONTEXT_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ITHREAD_CONTEXT_H
...
namespace Bloomberg::quantum
{
        ...
        struct IThreadContext : public IThreadContextBase
        {
            ...
            /// @brief Waits for the future associated with this context to be ready for a maximum of 'timeMs'
            /// milliseconds.
            ...
            ///          waitAt(total_continuations-1) on the last context in the chain (i.e. the context which is
            ...
            /// @brief Waits for the future in the 'num-th' continuation context to be ready for a maximum of 'timeMs'
            /// milliseconds.
            /// @details Allowed range for num is [-1, total_continuations). -1 is equivalent of calling wait() or
            ///          waitAt(total_continuations-1) on the last context in the chain (i.e. the context which is
            ///          returned via end()). Position 0 represents the first future in the chain.
            ...
            ///
            /// @code
            ///    IThreadContext<RET>::Ptr ctx =
            ///    Dispatcher::postFirst()->then()->...->then()->onError()->finally()->end();
            /// @endcode
            //-----------------------------------------------------------------------------------------
            ...
            ///              callable object must strictly be 'int f(ThreadContext<RET>::Ptr, ...)'.
            ...
            /// @brief Posts a function to run asynchronously. This is the error handler for a continuation chain and
            /// acts as
            ///        as a 'catch' clause.
            ...
            ///          if-and-only-if any previous functions in the continuation chain return an error or throw. When
            ///          a function which is part of a continuation chain has an error, all subsequent then() methods
            ...
            ///          functions have an error or not. It can be used for cleanup purposes, closing handles,
            ...
            /// @param[in] func Callable object.
            /// @param[in] args Variable list of arguments passed to the callable object.
            /// @note This function is non-blocking and returns immediately. After this function, the end() method must
            /// be called.
            template <class OTHER_RET = Deprecated, class FUNC, class... ARGS>
        ...
        inline log4cxx::LoggerPtr IThreadContext<RET>::logger =
            log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.IThreadContext" ) );
...
#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ITHREAD_CONTEXT_H
