...
namespace Bloomberg::quantum
{
    ...
    #define QUANTUM_SPINLOCK_BACKOFF_POLICY QUANTUM_BACKOFF_EXPONENTIAL
        ...
        // log4cxx::LoggerPtr SpinLockTraits::logger =
        // log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.SpinlockTraits" ) );
        //==============================================================================
        //                                  LockTraits
        //==============================================================================
        struct LockTraits
        ...
        inline log4cxx::LoggerPtr SpinLockTraits::logger =
            log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.SpinLockTraits" ) );
        inline log4cxx::LoggerPtr LockTraits::logger =
            log4cxx::Logger::getLogger ( std::string ( "com.github.doevelopper.premisses.atlas.concurrency.SpinLock.LockTraits" ) );
...
#include <com/github/doevelopper/atlassians/atlas/concurrency/SpinlockTraits.ipp>
