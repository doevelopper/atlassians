...
*/
#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICORO_PROMISE_H
#define COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICORO_PROMISE_H
...
namespace Bloomberg::quantum
{
        ...
        struct ICoroPromise : public Traits::DerivedFrom<PROMISE<T>, ICoroPromise<PROMISE, T>, IPromiseBase>
        {
            ...
            ICoroPromise([[maybe_unused]] Impl * derived)
            {
//                UNUSED(derived);
            }
...
#endif // COM_GITHUB_DOEVELOPPER_PREMISSES_ATLAS_CONCURRENCY_ICORO_PROMISE_H
