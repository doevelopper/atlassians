#ifndef COM_GITHUB_DOEVELOPPER_PREMISSES_TRIADA_EXCEPTIONS_HPP
#define COM_GITHUB_DOEVELOPPER_PREMISSES_TRIADA_EXCEPTIONS_HPP
...
#endif /* COM_GITHUB_DOEVELOPPER_PREMISSES_TRIADA_EXCEPTIONS_HPP */
