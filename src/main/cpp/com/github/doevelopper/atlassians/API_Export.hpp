#ifndef COM_GITHUB_DOEVELOPPER_ATLASSIANS_EXPORT_HPP
#define COM_GITHUB_DOEVELOPPER_ATLASSIANS_EXPORT_HPP

#include <com/github/doevelopper/atlassians/CompilerDetection.hpp>
#include <com/github/doevelopper/atlassians/Poison.hpp>
#include <functional>


/*!
 * @page Macros
 * @brief  Generic helper definitions for shared library support
 *      and Utility macros for handling private implementations.
 */
