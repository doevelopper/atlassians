...
log4cxx::LoggerPtr LocksTest::logger =
    log4cxx::Logger::getLogger(std::string("cfs.osal.test.LocksTest"));
...
void LocksTest::SetUp()
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    // testee = new ();
}

void LocksTest::TearDown()
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    // delete testee;
}

void LocksTest::runnable(Bloomberg::quantum::SpinLock * exclusiveLock)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    int locksTaken = 0;
...
void LocksTest::runThreads(int num)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    Bloomberg::quantum::SpinLock exclusiveLock;
    //Create 50 threads
...
void LocksTest::spinlockSettings(
        size_t min,
        size_t max,
        ...
        int enable)
{
    ...
    {
        val = 0;
        Bloomberg::quantum::SpinLockTraits::minSpins() = min;
        Bloomberg::quantum::SpinLockTraits::maxSpins() = max;
        Bloomberg::quantum::SpinLockTraits::numYieldsBeforeSleep() = numYields;
        Bloomberg::quantum::SpinLockTraits::sleepDuration() = sleepUs;

        LocksTest::runThreads(num);

        EXPECT_EQ(20*numLockAcquires, val);
    }
}

TEST_F(LocksTest, Spinlock) 
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    val = 0;
    Bloomberg::quantum::SpinLock spin;
    std::thread t1([&]() mutable 
    {
        int num = spins;
        while (num-- > 0) 
        {
            Bloomberg::quantum::SpinLock::Guard guard(spin);
...
TEST_F(LocksTest, Spinlock_Guards)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
...
TEST_F(LocksTest, Spinlock_HighContention)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    val = 0;
    int enable = -1;
...
TEST_F(LocksTest, ReadWriteSpinLock_LockReadMultipleTimes)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
...
TEST_F(LocksTest, ReadWriteSpinLock_LockReadAndWrite)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    int num = spins;
...
TEST_F(LocksTest, ReadWriteSpinLock_LockReadAndWriteList)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    int num = spins;
...
TEST_F(LocksTest, ReadWriteSpinLock_SingleLocks)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
...
TEST_F(LocksTest, ReadWriteSpinLock_UnlockingUnlockedIsNoOp)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    ReadWriteSpinLock lock;
...
TEST_F(LocksTest, ReadWriteSpinLock_TryLocks)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    ReadWriteSpinLock lock;
...
TEST_F(LocksTest, ReadWriteSpinLock_Guards)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    ReadWriteSpinLock lock;
...
TEST_F(LocksTest, ReadWriteSpinLock_UpgradeLock)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
...
TEST_F(LocksTest, ReadWriteSpinLock_UpgradeSingleReader)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    ReadWriteSpinLock lock;
...
TEST_F(LocksTest, ReadWriteSpinLock_TryUpgradeSingleReader)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    ReadWriteSpinLock lock;
...
TEST_F(LocksTest, ReadWriteSpinLock_UpgradeMultipleReaders)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    ReadWriteSpinLock lock;
...
TEST_F(LocksTest, ReadWriteMutex_SingleLocks)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
...
TEST_F(LocksTest, ReadWriteMutex_TryLocks)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    ReadWriteMutex mutex;
...
TEST_F(LocksTest, ReadWriteMutex_UpgradeToWrite)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
...
TEST_F(LocksTest, ReadWriteMutex_CoroUpgradeToWrite)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
...
TEST_F(LocksTest, ReadWriteMutex_Guards)
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    ReadWriteMutex mutex;
...
TEST_F(LocksTest, ReadWriteMutex_MultipleReadLocks) 
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
    using namespace Bloomberg::quantum;
    ReadWriteMutex mutex;
